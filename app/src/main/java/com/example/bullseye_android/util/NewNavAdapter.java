...
import static com.example.bullseye_android.util.NavAdapter.*;

public class NewNavAdapter extends RecyclerView.Adapter<NewNavAdapter.NavViewHolder> {
    ...
    public NewNavAdapter(AppCompatActivity activity, RecyclerView rv) {
