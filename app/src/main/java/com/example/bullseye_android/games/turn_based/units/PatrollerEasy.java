...
public class PatrollerEasy extends Patroller {
    public PatrollerEasy(String name, int x, int y, String icon, int movespeed, Node[][] graph, Tile[][] board, LifecycleOwner ctx, ArrayList<Pair<Integer, Integer>> patrolPoints) {
        super(name, x, y, icon, movespeed, Owners.EASY, graph, board, ctx, patrolPoints);
    }
}
